;; Stack-Insure: Decentralized Insurance Protocol
...
(define-public (create-insurance-pool
    ...
    (let ((pool-id (var-get next-pool-id)))
        ...
        ;; ensure description is checked
        (map-set insurance-pools { pool-id: pool-id } {
            name: name,
            description: description, ;; safe after length check
            total-staked: u0,
            active-policies: u0,
...
(define-public (purchase-policy
    ...
    (let (
        ...
        (map-set policies { policy-id: policy-id } {
            holder: tx-sender,
            pool-id: pool-id, ;; pool-id is checked via unwrap! above
